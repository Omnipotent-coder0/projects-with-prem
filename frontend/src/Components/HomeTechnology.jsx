...
const HomeTechnology = () => {
  const [items, setItems] = useState([
    {
      ...
      "urlToImage": "https://www.livemint.com/lm-img/img/2024/02/23/1600x900/21_1708699852586_1708699859458.jpg",
  ...
  return (
    <div className='m-20 mt-20'>
        <h1 className='text-5xl font-bold mb-12 '>Technology</h1>
